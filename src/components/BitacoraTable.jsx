...
/**
 * Componente reutilizable para mostrar la tabla de bitácora
 * Encapsula toda la lógica de filtrado, paginación y formato
 */
function BitacoraTable({ itemsPerPage = 5, isEmbedded = false }) {
  ...
  // Estilos para modo incrustado (AdminPanel)
  const containerClass = isEmbedded ? "space-y-4" : "space-y-6";
  const headerClass = isEmbedded ? "text-lg font-semibold" : "text-2xl font-bold";

  return (
    <div className={containerClass}>
      {!isEmbedded && (
        <div>
          <h2 className={`${headerClass} text-slate-900`}>📊 Bitácora de Auditoría</h2>
